...
class FillPermissionsForPengalaman extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPengalaman constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.pengalaman',
            'admin.pengalaman.index',
            'admin.pengalaman.create',
            'admin.pengalaman.show',
            'admin.pengalaman.edit',
            'admin.pengalaman.delete',
        ]);
