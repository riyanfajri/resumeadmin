                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('/home')}}"><i class="fa fa-home" aria-hidden="true"></i> Home</a></li>
                             <li class="breadcrumb-item"><a href="{{url('/gaya_hidup')}}"><i class="fa fa-home" aria-hidden="true"></i>  hidup & Hobi-Otomotif</a></li>
                            <li class="breadcrumb-item active" aria-current="page">{{$gaya_hidup->judul}}</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 col-xl-8">
                    ...
                    <?php $isinews = DB::table('isinews')->where('id_gaya_hidup',$gaya_hidup->id)->paginate(1); ?>
                        <!-- Single Catagory Post -->
                        <div class="blog-thumb mb-30">
                            <img src="{{asset($gaya_hidup->img)}}" alt="">
                        </div>

                        <div class="post-content">
                             <div class="post-meta">
                                    <a href="#">{{Carbon::parse("$gaya_hidup->created_at")->toFormattedDateString()}}</a>
                                   
                                </div>
                            <h1 class="post-title">{{$gaya_hidup->judul}}</h1>
                            <!-- Post Meta -->
