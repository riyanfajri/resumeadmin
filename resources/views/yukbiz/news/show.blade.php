                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('/home')}}"><i class="fa fa-home" aria-hidden="true"></i> Home</a></li>
                             <li class="breadcrumb-item"><a href="{{url('/news')}}"><i class="fa fa-home" aria-hidden="true"></i> News</a></li>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 col-xl-8">
                    ...
                    <?php $isinews = DB::table('isinews')->where('id_news',$news->id)->paginate(1); ?>
                        ...
                        <div class="post-content">
                             <div class="post-meta">
                                    <a href="#">{{Carbon::parse("$news->created_at")->toFormattedDateString()}}</a>
                                   
                                </div>
                            <h1 class="post-title">{{$news->judul}}</h1>
                            <!-- Post Meta -->
