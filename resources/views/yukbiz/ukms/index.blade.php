        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 col-xl-8">
                    ...
                    @foreach($ukms as $ukms1)

                    <?php $isinews = DB::table('isinews')->where('id_ukm',$ukms1->id)->first(); ?>
                        <!-- Single Catagory Post -->
                         <li class='p1520 art-list pos_rel' data-sort="1">   
                            <div class="fr mt5 pos_rel">
                                <a href="{{ route('ukms.show',[$ukms1->id]) }}">
                                    <img src="{{asset($ukms1->img)}}" class="shou2 bgwhite" height="90" width="120" alt="{{asset($ukms1->judul)}}" style="padding-top:18px"  />
                                </a>
                            </div>
                            <div class='mr140'">
                                ...
                                <div class="grey pt5">
                                    ...
                                    <time class="foot timeago" title="2019-05-17 08:57:52">{{Carbon::parse("$ukms1->created_at")->diffForHumans()}} </time>
                                </div>
                                <div class="sharecot pos_abs nw" data-href="" data-title="{{$ukms1->judul}}" data-via="tribunjateng"></div>
                            </div>
                            <div class="cl2"></div>
                        </li>
                    @endforeach
