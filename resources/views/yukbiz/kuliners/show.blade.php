                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('/home')}}"><i class="fa fa-home" aria-hidden="true"></i> Home</a></li>
                             <li class="breadcrumb-item"><a href="{{url('/kuliners')}}"><i class="fa fa-home" aria-hidden="true"></i> Kuliner</a></li>
                            <li class="breadcrumb-item active" aria-current="page">{{$kuliners->judul}}</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 col-xl-8">
                    ...
                    <?php $isinews = DB::table('isinews')->where('id_kuliner',$kuliners->id)->paginate(1); ?>
                        <!-- Single Catagory Post -->
                        <div class="blog-thumb mb-30">
                            <img src="{{asset($kuliners->img)}}" alt="">
                        </div>

                        <div class="post-content">
                             <div class="post-meta">
                                    <a href="#">{{Carbon::parse("$kuliners->created_at")->toFormattedDateString()}}</a>
                                   
                                </div>
                            <h1 class="post-title">{{$kuliners->judul}}</h1>
                            <!-- Post Meta -->
